/**
 * Enterprise API Management - central service for API keys, webhooks, logs, usage, health, security.
 * All endpoints expect FastAPI backend under /api/v1/enterprise/api
 */
const BASE = `${(import.meta.env.VITE_API_BASE_URL || "").replace(/\/$/, "")}/api/v1/enterprise/api`;
...
/** Returns URL for log export; use fetch with token and blob for actual download. */
